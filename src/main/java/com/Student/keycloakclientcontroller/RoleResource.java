...
public class RoleResource {
  ...
  public  RoleResource(KeycloakSecurityUtil keycloakUtil){
    ...
    public Response createRole(@RequestBody  Role role) {
        ...
        realms.add("manager");
        composites.setRealm(realms);
        List<String> clientRoleList = new ArrayList<>();
        clientRoleList.add("admin_client");
        clientRoleList.add("user_client");
        clients.put("springboot",clientRoleList);
